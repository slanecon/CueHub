...
### macOS Desktop App (ADRCueManager/)
- `cd ADRCueManager && xcodegen generate` — regenerate Xcode project from project.yml
- `xcodebuild -project ADRCueManager.xcodeproj -scheme ADRCueManager build` — build from CLI
...
- Web assets (index.html, app.js, style.css) are in public/ for the server and copied to ADRCueManager/Resources/Web/ for the desktop app bundle
